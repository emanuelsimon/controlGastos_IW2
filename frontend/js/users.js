...
inicializarTabla(
    ...
    <tr>
        ...
        <td>
            ...
            <button class="cg-filter" onclick="event.stopPropagation(); window.location.href='../advisor/send-recommendation.html?userId=${user.id}&nombre=${encodeURIComponent(user.nombre + ' ' + user.apellido)}'">💡 Recomendar</button>
        </td>
    </tr>
    `,    
