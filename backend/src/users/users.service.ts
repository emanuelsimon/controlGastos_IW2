...
export class UsersService {
  constructor(
    //Con el decorador @InjectRepository(User) le decimos a Nest que queremos inyectar el 
    // repositorio de User, esto nos permite hacer consultas a la base de datos para obtener, 
    // crear, actualizar o eliminar usuarios
    @InjectRepository(User)
    private usersRepository: Repository<User>,
  ) { }

  //Create: Método encargado de crear un nuevo usuario en la base de datos, utilizando 
  // el repositorio de User que hemos inyectado, devolviendo el usuario creado como resultado
  ...
  // esto nos va a servir para el proceso de autenticación, para verificar si el email 
