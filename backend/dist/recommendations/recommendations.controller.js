...
let RecommendationsController = class RecommendationsController {
    ...
    async getByUsuario(user, userId) {
        if (user.rol !== 'asesor' && user.userId !== Number(userId)) {
            throw new common_1.ForbiddenException('No tenés permiso para ver estas recomendaciones');
        }
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], RecommendationsController.prototype, "getByUsuario", null);
